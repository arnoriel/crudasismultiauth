                ...
                <div class="card-body">
                    <form action="{{route('guru.store')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" placeholder="Masukkan Nama guru">
                            @error('nama')
                            ...
                            <label for="">Masukan Wali Kelas</label>
                                 <select class="form-select" aria-label="Default select example" name="walkel" id="" >
                                ...
                                <input type="number" name="telepon" class="form-control @error('telepon') is-invalid @enderror" placeholder="Masukkan telepon guru">
                                @error('telepon')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                                ...
                                <select class="form-select" aria-label="Default select example" name="mapel" id="" >
                            ...
                            <input type="text" name="alamat" class="form-control @error('alamat') is-invalid @enderror" placeholder="Masukkan alamat guru">
                            @error('alamat')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
